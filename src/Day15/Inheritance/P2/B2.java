...
import Day15.Inheritance.P1.C1;
...
//        System.out.println("Accessing package P1 default variable l thru A1"+A1.n); // diff package
//        System.out.println("Accessing package P1 protected variable l thru A1"+A1.o); // not family
...
//        System.out.println("Accessing package P1 default variable l thru C1"+C1.n); // diff package
//        System.out.println("Accessing package P1 protected variable l thru C1"+C1.o); // not fam
...
//        System.out.println("Accessing package P2 protected variable l thru C2"+C2.o); // not fam
    }
}
